...
_PLANNING_TERRAIN_CHAR_PX = 14.0
_PLANNING_TERRAIN_CELL_PAD_PX = 32.0
_PLANNING_TERRAIN_COL_SAFETY_PX = 32.0
...
_PLANNING_LIVE_REF_WIDTH_PX = 1400.0 - 2.0 * round(5.0 * 96.0 / 25.4)
_PLANNING_LIVE_TERRAIN_FRAC = 0.14
_PLANNING_COL_TERRAIN_BOOST = max(
    1.0,
    _PLANNING_TERRAIN_COL_MIN_PX
    / (_PLANNING_LIVE_REF_WIDTH_PX * _PLANNING_LIVE_TERRAIN_FRAC),
)
